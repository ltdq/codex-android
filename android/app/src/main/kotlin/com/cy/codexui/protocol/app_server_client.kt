...
import com.cy.codexui.protocol.protocol.v2.CommandExecResponse
import com.cy.codexui.protocol.protocol.v2.CommandExecutionOutputDelta
import com.cy.codexui.protocol.protocol.v2.ConfigBatchWriteParams
import com.cy.codexui.protocol.protocol.v2.ConfigLayer
...
import com.cy.codexui.protocol.protocol.v2.ConfigWarningNotification
import com.cy.codexui.protocol.protocol.v2.ConfigWriteResponse
import com.cy.codexui.protocol.protocol.v2.ConsumeRateLimitResetCreditResponse
import com.cy.codexui.protocol.protocol.v2.DeprecationNoticeNotification
import com.cy.codexui.protocol.protocol.v2.DiagnosticSeverity
import com.cy.codexui.protocol.protocol.v2.ElicitationCountResponse
import com.cy.codexui.protocol.protocol.v2.EnvironmentInfoResponse
import com.cy.codexui.protocol.protocol.v2.EnvironmentStatusResponse
import com.cy.codexui.protocol.protocol.v2.ErrorNotification
...
import com.cy.codexui.protocol.protocol.v2.FileChangeOutputDelta
import com.cy.codexui.protocol.protocol.v2.FileChangePatchUpdatedNotification
import com.cy.codexui.protocol.protocol.v2.FileMetadata
import com.cy.codexui.protocol.protocol.v2.FileUpdateChange
import com.cy.codexui.protocol.protocol.v2.FsChangedNotification
import com.cy.codexui.protocol.protocol.v2.FuzzyFileSearchResult
import com.cy.codexui.protocol.protocol.v2.FuzzyFileSearchSessionCompletedNotification
import com.cy.codexui.protocol.protocol.v2.FuzzyFileSearchSessionUpdatedNotification
...
import com.cy.codexui.protocol.protocol.v2.McpServerToolCallResponse
import com.cy.codexui.protocol.protocol.v2.McpStartupStatusUpdated
import com.cy.codexui.protocol.protocol.v2.McpToolCallProgress
import com.cy.codexui.protocol.protocol.v2.MemoryStatusResponse
import com.cy.codexui.protocol.protocol.v2.ModelPreset
import com.cy.codexui.protocol.protocol.v2.ModelProviderAuthRecoveryNotification
import com.cy.codexui.protocol.protocol.v2.ModelRerouted
import com.cy.codexui.protocol.protocol.v2.ModelSafetyBufferingUpdatedNotification
import com.cy.codexui.protocol.protocol.v2.ModelVerificationNotification
...
import com.cy.codexui.protocol.protocol.v2.PluginListResponse
import com.cy.codexui.protocol.protocol.v2.PluginShareEntry
import com.cy.codexui.protocol.protocol.v2.ProcessExitedNotification
import com.cy.codexui.protocol.protocol.v2.ProcessOutputDeltaNotification
...
import com.cy.codexui.protocol.protocol.v2.RemoteControlStatusChangedNotification
import com.cy.codexui.protocol.protocol.v2.ReviewStartResponse
...
import com.cy.codexui.protocol.protocol.v2.ServerRequestResolved
import com.cy.codexui.protocol.protocol.v2.SkillEntry
import com.cy.codexui.protocol.protocol.v2.StrictReviewRequiredNotification
...
import com.cy.codexui.protocol.protocol.v2.ThreadSettingsUpdated
...
import com.cy.codexui.protocol.protocol.v2.TurnPlanUpdated
...
import com.cy.codexui.protocol.protocol.v2.UserVerificationVerifyResponse
import com.cy.codexui.protocol.protocol.v2.WarningNotification
import com.cy.codexui.protocol.protocol.v2.WindowsSandboxReadinessResponse
import com.cy.codexui.protocol.protocol.v2.WindowsSandboxSetupCompletedNotification
import com.cy.codexui.protocol.protocol.v2.WindowsSandboxSetupMode
import com.cy.codexui.protocol.protocol.v2.WindowsSandboxSetupStartResponse
...
sealed interface AppServerEvent {
    ...
    data class FileChangeOutputDelta(
        ...
        val delta: com.cy.codexui.protocol.protocol.v2.FileChangeOutputDelta,
    ) : AppServerEvent
...
sealed interface ApprovalRequest {
    ...
    data class Exec(
        ...
        val params: com.cy.codexui.protocol.protocol.v2.CommandExecutionApprovalParams,
    ) : ApprovalRequest
    ...
    data class ApplyPatch(
        ...
        override val itemId: String,
        override val receivedAt: Long,
        val params: com.cy.codexui.protocol.protocol.v2.FileChangeApprovalParams,
    ) : ApprovalRequest
    ...
    data class Permissions(
        ...
        override val itemId: String,
        override val receivedAt: Long,
        val params: com.cy.codexui.protocol.protocol.v2.PermissionsApprovalParams,
    ) : ApprovalRequest
    ...
    data class UserInput(
        ...
        override val itemId: String,
        override val receivedAt: Long,
        val params: com.cy.codexui.protocol.protocol.v2.ToolRequestUserInputParams,
    ) : ApprovalRequest
    ...
    data class DynamicTool(
        ...
        override val itemId: String,
        override val receivedAt: Long,
        val params: com.cy.codexui.protocol.protocol.v2.DynamicToolCallParams,
    ) : ApprovalRequest
...
sealed interface ApprovalResponse {
    data class CommandExecution(
        val decision: com.cy.codexui.protocol.protocol.v2.CommandExecutionApprovalDecision,
    ) : ApprovalResponse

    data class FileChange(
        val decision: com.cy.codexui.protocol.protocol.v2.FileChangeApprovalDecision,
    ) : ApprovalResponse

    data class Permissions(
        val decision: com.cy.codexui.protocol.protocol.v2.PermissionsApprovalDecision,
    ) : ApprovalResponse

    data class UserInput(
        val answers: List<com.cy.codexui.protocol.protocol.v2.UserInputAnswer>,
    ) : ApprovalResponse
    ...
    data class DynamicTool(
        val result: com.cy.codexui.protocol.protocol.v2.DynamicToolCallResponse,
    ) : ApprovalResponse
 ...
 * [com.cy.codexui.protocol.protocol.v2.ClientRequestMethod]. A method that a backend cannot serve
...
interface AppServerClient {
    ...
    suspend fun updateThreadSettings(
        ...
        approvalPolicy: com.cy.codexui.protocol.protocol.v2.AskForApproval? = null,
        collaborationMode: com.cy.codexui.protocol.protocol.v2.CollaborationMode? = null,
        personality: com.cy.codexui.protocol.protocol.v2.Personality? = null,
    ...
    suspend fun updateThreadSettingsFull(params: com.cy.codexui.protocol.protocol.v2.ThreadSettingsUpdateParams): Result<Unit> = unsupported("updateThreadSettingsFull")
    ...
    suspend fun readConfigRequirements(): Result<com.cy.codexui.protocol.protocol.v2.ConfigRequirementsReadResponse> = unsupported("readConfigRequirements")
...
data class ThreadTurnsPage(
    val turns: List<com.cy.codexui.protocol.protocol.v2.Turn> = emptyList(),
    val nextCursor: String? = null,
)
...
val ThreadStatus.isWaitingOnUser: Boolean
    get() = this is ThreadStatus.Active && activeFlags.any {
        it == com.cy.codexui.protocol.protocol.v2.ThreadActiveFlag.WaitingOnApproval ||
            it == com.cy.codexui.protocol.protocol.v2.ThreadActiveFlag.WaitingOnUserInput
    }
