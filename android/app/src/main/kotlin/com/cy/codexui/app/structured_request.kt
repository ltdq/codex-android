...
import com.cy.codexui.protocol.protocol.v2.SandboxMode
import com.cy.codexui.protocol.protocol.v2.SandboxPolicy
...
internal suspend fun structuredTurn(
    ...
    try {
        ...
        val items = client.readThread(
            com.cy.codexui.protocol.protocol.v2.ThreadReadParams(threadId),
        ).getOrThrow().items
        items.asReversed()
...
internal fun firstUserMessageText(items: List<com.cy.codexui.protocol.protocol.item.ThreadItem>): String? =
