...
val com.cy.codexui.protocol.protocol.v2.ThreadStatus.isWaitingOnUser: Boolean
    get() = this is com.cy.codexui.protocol.protocol.v2.ThreadStatus.Active && activeFlags.any {
...
fun com.cy.codexui.protocol.protocol.v2.ThreadStatus.tone(): ThreadStatusTone = when (this) {
    is com.cy.codexui.protocol.protocol.v2.ThreadStatus.Idle -> ThreadStatusTone.Idle
    is com.cy.codexui.protocol.protocol.v2.ThreadStatus.NotLoaded -> ThreadStatusTone.Idle
    is com.cy.codexui.protocol.protocol.v2.ThreadStatus.Active ->
        if (isWaitingOnUser) ThreadStatusTone.Waiting else ThreadStatusTone.Running

    is com.cy.codexui.protocol.protocol.v2.ThreadStatus.SystemError -> ThreadStatusTone.Failed
}
