            ...
            runBlocking {
                withTimeout(180_000) {
                    ...
                    try {
                        ...
                        val thread = client.startThread(installation.workspace.path).getOrThrow()
                        ...
                        val history = client.readThread(thread.threadId).getOrThrow()
                        ...
                        val restored = client.readThread(thread.threadId).getOrThrow()
