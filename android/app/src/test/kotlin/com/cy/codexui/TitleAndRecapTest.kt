...
import com.cy.codexui.app.RecapPromptPrefix
import com.cy.codexui.app.parseRecap
import com.cy.codexui.app.parseThreadTitle
import com.cy.codexui.app.recapHistory
import com.cy.codexui.app.takeUtf8Bytes
...
class TitleAndRecapTest {
    ...
    fun `generated titles are normalized like the TUI`() {
        ...
        assertEquals("😀", com.cy.codexui.app.takeCodePoints("😀😀", 1))
    }
