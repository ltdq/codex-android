...
COREUTILS_VER="${COREUTILS_VER:-9.12}"
FINDUTILS_VER="${FINDUTILS_VER:-4.11.0}"
GREP_VER="${GREP_VER:-3.12}"
PROCPS_VER="${PROCPS_VER:-4.0.7}"
BZIP2_VER="${BZIP2_VER:-1.0.8}"
UNZIP_VER="${UNZIP_VER:-6.0}"
ZIP_VER="${ZIP_VER:-3.0}"
TREE_VER="${TREE_VER:-2.3.2}"
WHICH_VER="${WHICH_VER:-2.25}"
BC_VER="${BC_VER:-1.08.2}"
VIM_VER="${VIM_VER:-9.1.0000}"
